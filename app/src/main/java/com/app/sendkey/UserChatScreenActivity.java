...
public class UserChatScreenActivity extends AppCompatActivity {
    ...
    {
        super.onBackPressed();
        startActivity(new Intent(UserChatScreenActivity.this, UserActivity.class));
        finish();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.sign_out_menu:
                signOut();
                startActivity(new Intent(UserChatScreenActivity.this, LoginActivity.class));
                return true;
            default:
